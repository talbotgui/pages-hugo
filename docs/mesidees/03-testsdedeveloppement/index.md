...
De l'autre côté, les tests sont unitaires du moment qu'ils participent à la construction de l'application durant les travaux du développeur. Et ce quelque soit la granularité du SUT, que les tests soient unitaires (selon la première définition), d'intégration ou applicatif (de bout en bout avec tous les composants et systèmes externes).

Et si, pour se simplifier la vie, on parlait de tests de développement utilisant des TU, TI et TA ?

Et là, on me pose la question “Et les tests de non-regression ?”. Ma réponse est simple “Un test de non-regression a été un test de développement mais le dev est fini et le test est resté.”
